...
ph_1 = out[0:64,1].squeeze().astype(int)
ph_2 = out[0:64,2].squeeze().astype(int)
ph_3 = out[0:64,3].squeeze().astype(int)
ph_4 = out[0:64,4].squeeze().astype(int)
ph_5 = out[0:64,5].squeeze().astype(int)
ph_6 = out[0:64,6].squeeze().astype(int)

rx = out[0:64,7].squeeze()
...
with open('6-pulse_64-step_DQC_phase_cycle_20230914.txt', 'w') as f:
    f.write(ph_1_str)
    f.write(ph_2_str)
    f.write(ph_3_str)
    f.write(ph_4_str)
